...
function clearSystemCacheAndRestart() {
    ...
    const steps = [
        ...
        { text: "Purge du cache Service Worker ('labo-it-cache-v2.0.0')...", action: () => {
            if ('caches' in window) {
        ...
        { text: "Installation des nouveautés de la version 2.0.0...", action: () => {
            return new Promise((resolve) => {
                setTimeout(() => {
                    addLogLine("   🚀 Nouveautés de la version v2.0.0 :", "running");
                    setTimeout(() => {
                    ...
                    setTimeout(() => {
                        addLogLine("     • Version globale mise à jour à v2.0.0", "success");
                        if (typeof playChime === 'function') playChime('success');
                        resolve();
                    }, 800);
                }, 300);
        ...
        { text: "Redémarrage de LABO-IT CONTROL v2.0.0...", action: () => {
...
init();
console.log('%c🚀 LABO-IT CONTROL %c| %cVersion 2.0.0 %c| %cPrêt à l\'emploi',
