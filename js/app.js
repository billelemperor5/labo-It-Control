...
function clearSystemCacheAndRestart() {
    ...
    const steps = [
        ...
        { text: "Purge du cache Service Worker ('labo-it-cache-v3.3')...", action: () => {
            if ('caches' in window) {
        ...
        { text: "Installation des nouveautés de la version 3.3...", action: () => {
            return new Promise((resolve) => {
                setTimeout(() => {
                    addLogLine("   🚀 Nouveautés de la version v3.3 :", "running");
                    setTimeout(() => {
                    ...
                    setTimeout(() => {
                        addLogLine("     • Version globale mise à jour à v3.3", "success");
                        if (typeof playChime === 'function') playChime('success');
                        resolve();
                    }, 800);
                }, 300);
        ...
        { text: "Redémarrage de LABO-IT CONTROL v3.3...", action: () => {
...
init();
console.log('%c🚀 LABO-IT CONTROL %c| %cVersion 3.3 %c| %cPrêt à l\'emploi',
